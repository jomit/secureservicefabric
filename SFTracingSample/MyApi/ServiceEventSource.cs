...
namespace MyApi
{
    [EventSource(Name = "MyCompany-SFTracingSample-MyApi")]
    internal sealed class ServiceEventSource : EventSource
    {
        ...
        [Event(ServiceRequestStartEventId, Level = EventLevel.Informational, Message = "MyApi service request '{0}' started", Keywords = Keywords.Requests)]
        ...
        [Event(ServiceRequestStopEventId, Level = EventLevel.Informational, Message = "MyApi service request '{0}' finished", Keywords = Keywords.Requests)]
