...
namespace MyBackEnd
{
    [EventSource(Name = "MyCompany-SFTracingSample-MyBackEnd")]
    internal sealed class ServiceEventSource : EventSource
    {
        ...
        [Event(ServiceRequestStartEventId, Level = EventLevel.Informational, Message = "MyBackend service request '{0}' started", Keywords = Keywords.Requests)]
        ...
        [Event(ServiceRequestStopEventId, Level = EventLevel.Informational, Message = "MyBackend service request '{0}' finished", Keywords = Keywords.Requests)]
