...
function Cleanup-Cert
{
    ...
    {
        Get-ChildItem -Path $cerLoc | ? { $_.Subject -like "*jacksch.westus.cloudapp.azure.com*" } | Remove-Item
    }
}
...
if($Install)
{
    ...
    $certSubjectName = "CN=jacksch.westus.cloudapp.azure.com"
    ...
    $cert = $srcStore.certificates -match "CN=jacksch.westus.cloudapp.azure.com"
